...
- **Pinch-to-Zoom Scaling**: Multi-touch 2-finger pinch-to-zoom enables flexible reading magnification (`0.75f` to `2.5f`) matching the Library reader, scaling all journal directory headers, prayer point texts, and prompts proportionally with floating zoom pill and top bar reset triggers.
