...
1. **Pristine Home Screen & Gestural Navigation**:
   - The app launches to an uncluttered blank canvas featuring strictly two centered options:
     1. **Start praying**
     2. **Log prayer points**
...
3. **Contemplative, Passive Prayer Flow ("Start Praying")**:
   ...
   - **Card Focus with Configurable Batches**: Displays prayer points one card at a time by default, with user settings to show 1, 2, 3, 4, or 5 items per view.
